        ...
        <form>
          <div className="form-row">
            <div className="form-group col-md-6">
              ...
              <h3 style={{border:'1px solid #ccc',borderRadius:'4px',padding:'10px',fontSize:'1rem'}}>
          ...
          <div className="form-row">
            <div className="form-group col-md-6">
              <label>Address</label>
              <input type="text" className="form-control" name="address" value={project.address} onChange={handleChange}/>
            </div>
            <div className="form-group col-md-6">
              <label>Investment</label>
              <input type="text" className="form-control" name="invest" value={project.invest} onChange={handleChange}/>
            </div>
          </div>
          ...
          <div className="form-row">
            <div className="form-group col-md-6">
              <label>Builder</label>
              <input type="text" className="form-control" name="builder" value={project.builder} onChange={handleChange}/>
            </div>
            <div className="form-group col-md-6">
              <label>Possession Date</label>
              <input type="text" className="form-control" name="possession_date" value={project.possession_date} onChange={handleChange}/>
            </div>
          </div>
