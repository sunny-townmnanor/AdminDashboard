...
const handleSubmit = async (e) => {
    ...
    try {
        const response = await axios.post('https://www.townmanor.ai/api/blogs', newBlogData, {
        ...
        setMessage('Error uploading blog. Please try again.');
        console.error('Error uploading blog:', error);
    }
};

    return (
        <div className="upload-blog-form" style={{ width: '80%', margin: '2vh auto', padding: '16px' }}>
